...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      var handlers = _this.events[eventName] || []; // either empty array or current array of callbacks for event

      handlers.push(callback); // add new callback to array for event

      _this.events[eventName] = handlers; // reassign array for event
    };
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.url).then(function (response) {
      ...
      response.data.forEach(function (i) {
        ...
        _this.models.push(_this.deserialize(i));
      });
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./Eventing":"src/models/Eventing.ts","./Collection":"src/models/Collection.ts","./APISync":"src/models/APISync.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    ...
    value: function render() {
      ...
      /* create an element of type template */

      templateElement.innerHTML = this.template();
      /* set its inner content to the output of template method */
      ...
      /* append template to the parent element */
    }
  }]);
...
var UserEdit = /*#__PURE__*/function (_View_1$View) {
  ...
  _createClass(UserEdit, [{
    ...
    key: "onRender",
    value: function onRender() {
      var userShow = new UserShow_1.UserShow(this.regions.userShow, this.model).render();
      var userForm = new UserForm_1.UserForm(this.regions.userForm, this.model).render();
    }
  }]);
...
var user = User_1.User.create(attrs);
