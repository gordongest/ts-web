...
function () {
  function User(data) {
    ...
    this.attributes = new Atrributes_1.Attributes(data);
  }
...
exports.User = User;
},{"./Eventing":"src/models/Eventing.ts","./APISync":"src/models/APISync.ts","./Atrributes":"src/models/Atrributes.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
