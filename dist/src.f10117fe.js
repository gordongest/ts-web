...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Atrributes":"src/models/Atrributes.ts","./Eventing":"src/models/Eventing.ts","./APISync":"src/models/APISync.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
